...
function ProductList() {
    ...
    const handleAddToCart = (plant) => {
        // Dispatch the plant to the global store
            ...
            <div key={index}>
                ...
                <div className="product-list">
                    ...
                    <div className="product-card" key={plantIndex}>
                        ...
                        <img className="product-image" src={plant.image} alt={`Image of ${plant.name}`} />
                        <div className="product-price">{plant.cost}</div>
                        <div className="product-description">{plant.description || "No description available"}</div>
                        <button
